...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        aboutText: { en: `I am a fourth-year AI student in <a class="hyperlink" href="https://vilniustech.lt" target="_blank" rel="noopener noreferrer">Vilnius Tech</a> with a passion for programming and data. I have hands-on experience building web applications and am very skilled with Oracle SQL for database work. In my AI studies, I have completed projects in Deep Learning, Computer Vision, and Big Data. I am a friendly and hardworking person, excited to use my skills to help build amazing technology.`, lt: `Esu ketvirto kurso DI studentas <a class="hyperlink" href="https://vilniustech.lt" target="_blank" rel="noopener noreferrer">Vilniaus Tech</a> universitete. Domiuosi programavimu ir duomenimis. Esu kūręs interneto puslapių ir gerai moku Oracle SQL darbui su duomenų bazėmis. Studijuodamas DI, atlikau projektus apie gilųjį mokymąsi, kompiuterinį matymą ir didžiuosius duomenis. Esu draugiškas ir darbštus žmogus, noriu savo įgūdžius panaudoti kuriant įdomias technologijas.` },
        ...
        project5Desc: { en: "Developed a deep learning model to automatically classify galaxies by their shape (Elliptical, Spiral, etc.) from raw astronomical images. \nUtilized a ResNet50V2 architecture with transfer learning, followed by fine-tuning with a low learning rate to specialize the model for galactic structures. Implemented image augmentation (rotations, flips, zooms) to create a robust, generalized model. The highly imbalanced dataset was undersampled to ensure each class was represen`ted equally during training.The final model, trained on 224x224 images, achieved 76% accuracy on the unseen test set, successfully distinguishing between four distinct galaxy morphologies.", lt: "Padariau giluminio mokymosi modelį, kuris automatiškai atpažįsta galaktikų formas (elipsinės, spiralės ir pan.) iš paprastų astronominių nuotraukų. Naudojau ResNet50V2 tinklą su perkeltu mokymusi ir vėliau šiek tiek patobulinau su mažu mokymosi greičiu, kad modelis geriau suprastų galaktikas. Pridėjau nuotraukų keitimų (sukimai, apvertimai, priartinimai), kad modelis būtų tvirtesnis. Kadangi duomenų buvo labai nevienodai, sumažinau kai kurių klasių kiekį, kad visų būtų po lygiai. Modelis buvo mokytas su 224x224 dydžio paveikslėliais ir pasiekė 76% tikslumą su nematytomis nuotraukomis, atskirdamas keturias galaktikų rūšis." },
